...
const AUTHORS = {
  'Hermetic Labs': {
    id: 'hermetic',
    name: 'Hermetic Labs',
    avatar: 'images/hermetic-logo-transparent.png',
    bio: 'Hermetic Labs builds air-gapped, privacy-first software modules for the EVE-OS ecosystem. From medical triage to enterprise connectors — everything ships hermetically sealed.',
    socialLinks: { website: 'https://7hermeticlabs.com', email: 'mailto:Frontdesk@7hermeticlabs.com' },
    productCount: 0,
    totalSales: 8500,
  },
  'EVE Core Team': {
    ...
    name: 'EVE Core Team',
    avatar: 'images/hermetic-logo-transparent.png',
    bio: 'Core development team building enterprise-grade connectors, compliance modules, and platform infrastructure for EVE-OS.',
    socialLinks: { website: 'https://7hermeticlabs.com', email: 'mailto:Frontdesk@7hermeticlabs.com' },
    productCount: 0,
    totalSales: 15000,
  },
  'EVE OS': {
    ...
    name: 'EVE OS',
    avatar: 'images/hermetic-logo-transparent.png',
    bio: 'Official EVE OS modules and integrations. The autonomous operating system for hermetic computing.',
    socialLinks: { website: 'https://7hermeticlabs.com', email: 'mailto:Frontdesk@7hermeticlabs.com' },
    productCount: 0,
    totalSales: 12000,
  },
